...
<head>
	<% 
		...
		boardList = boardDAO.getList(sort, "");
	%>
	<meta charset="UTF-8">
	...
	<style>
		...
		#writeBtn {
			...
			border: 3px solid #4adaaf;
			border-radius: 50px;
			color: white;
		}
		#writeBtn:hover{
			background-color: #42c49d;
			border: 3px solid #42c49d;
		}
	</style>
</head>
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarCollapse">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active" style="border-bottom: 2px solid #4adaaf;"><a class="nav-link" href="index.jsp" style="color:#4adaaf;font-weight:bold;">여행
							피드</a></li>
				</ul>
	...
	<div id="myCarousel" class="carousel slide" data-ride="carousel" style="margin-top:62px;padding-bottom: 60px;">
	...
	<section class="container" style="padding:0px;padding-bottom: 60px;">
		<button onclick="location.href='<% if(userID != null) out.println("write.jsp'"); else out.println("login.jsp'");%>;" class="menuBtn" id="writeBtn">+</button>
		<button class="menuBtn" id="upBtn">↑</button>
		<div class="row" style="margin-bottom: 15px;">
			<div class="col-sm" style="height:30px; line-height: 30px;"><strong>지금의 여행</strong></div>
			<div class="col-sm" style="height:30px;">
				<form name="sortForm" action="index.jsp" method="get">
					<div class="form-group pull-right">
						<select class="form-control" style="height:30px;font-size: 10px;line-height:30px;" name="sort"
						onchange="sortFunction()">
							<option value="인기순" <%if(sort.equals("인기순")) out.println("selected");%>>인기순</option>
							<option value="최신순" <%if(sort.equals("최신순")) out.println("selected");%>>최신순</option>
						</select>
					</div>
				</form>
			</div>
